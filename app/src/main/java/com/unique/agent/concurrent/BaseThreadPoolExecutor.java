...
public class BaseThreadPoolExecutor extends ThreadPoolExecutor implements  ThreadPool{
    ...
    public Future<Void> submit(final Runnable task) {
        Log.i("PRAV","Task: "+task);
        return super.submit(task, (Void) null);
    }

    /** @see java.util.concurrent.ThreadPoolExecutor#shutdownNow() */
    @Override
    public void shutdown() {
        Log.i("PRAV", "Shutting down thread pool "+ this);
        shutdownNow();
    }
